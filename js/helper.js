...
var HTMLskills = '<ul class="flex-box">%data%</ul>';

//var HTMLlogoURL = '<img src="%data%" class="logoURL">';
...
var HTMLonlineClasses = '<h3 id="online-h3" >Online Courses</h3>';
...
function initializeMap() {
  ...
  */
  function locationFinder() {
    ...
    edu.unis.forEach(function(uni){
      locations.push(uni.location);
    });
